...
if(!isset ($_SESSION['isLoggedin']) && $_SESSION['isLoggedin'] !== TRUE){
    ...
    if($note_id==""){
        ...
        $Query = mysql_query("SELECT * FROM `tbl_note` where `note_id`='$note_id' LIMIT 0,1 ");
                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            <form action="update-note.php" method="post" onsubmit="return checkForm();" enctype="multipart/form-data">
                                                <input type="hidden" name="note_id" value="<?php echo $note_detail['note_id']; ?>" />
                                            <!-- start id-form -->
                                            <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                <tr>
                                                    <th valign="top">Title:</th>
                                                    <td><input type="text" class="inp-form" name="title" id="title" value="<?php echo $note_detail['note_title'] ?>" /></td>
                                                    <td></td>
                                                </tr>
                                                <tr>
                                                        ...
                                                        <select  class="sel_box" name="category" id="category">
                                                            ...
                                                            <?php
                                                                ...
                                                                while($result = mysql_fetch_assoc($cat_query)){
                                                                    $select = ($note_detail['note_cat_id']==$result['cat_id'])?'selected="selected"':"";
                                                            ?>
                                                            <option value="<?php echo $result['cat_id']; ?>" <?php echo $select; ?> ><?php echo $result['cat_title']; ?></option>
                                                            <?php
                                                                }
                                                            ?>
                                                        </select>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><textarea name="text_desc" id="text_desc" cols="" class="form-textarea"><?php echo $note_detail['note_desc'] ?></textarea></td>
                                                    <td></td>
                                                </tr>
                                                <tr>
