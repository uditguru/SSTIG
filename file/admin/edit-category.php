...
if(!isset ($_SESSION['isLoggedin']) && $_SESSION['isLoggedin'] !== TRUE){
    ...
    $cat_query = mysql_query("SELECT * FROM `tbl_category` WHERE `cat_id`='$id';");
    $cat_detail = mysql_fetch_assoc($cat_query);
}
?>
                            ...
                            <div id="content-table-inner">
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            <!-- start id-form -->
                                            <form action="update-categorty.php" method="post" onsubmit="return checkForm();">
                                            <input type="hidden" name="cat_id" id="cat_id" value="<?php echo $cat_detail['cat_id']; ?>" />
                                            <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                <tr>
                                                    <th valign="top">Category name:</th>
                                                    <td><input type="text" name="cat_name" id="cat_name" class="inp-form" value="<?php echo $cat_detail['cat_title']; ?>"/></td>
                                                    <td>
