                                    ...
                                    <form id="mainform" action="">
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                                            <tr>
                                                ...
                                                <th class="table-header-options line-left"><a href="">Added By</a></th>
                                                <th class="table-header-options line-left"><a href="">Action</a></th>
                                            </tr>
                                            <?php
                                                $cat_query = mysql_query("SELECT * FROM `tbl_note`,`tbl_user`, `tbl_category` WHERE `tbl_note`.`note_cat_id` = `tbl_category`.`cat_id` AND `tbl_note`.`user_id`=`tbl_user`.`user_id`  ORDER BY `tbl_note`.`note_dateAdded` DESC");
                                                $s_no = 1;
                                            ...
                                            ?>
                                                <tr <?php echo $class; ?>>
                                                    ...
                                                    <td><a href="read-note.php?id=<?php echo $result['note_id']; ?>">Read</a></td>
                                                </tr>
                                            <?php
                                                    $s_no++;
                                                }//while ends
